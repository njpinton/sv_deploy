...
# Addendum
data_arg.add_argument('--top_db',type=int, default=10, help="decibel threshold for voice activity detection")
data_arg.add_argument('--duration',type=int, default=5, help="duration in seconds of recording in voice capture")
data_arg.add_argument('--threshold',type=float,default=0.70, help="set threshold for acceptance or rejection")
...
train_arg.add_argument('--N', type=int, default=1, help="number of speakers of batch")
